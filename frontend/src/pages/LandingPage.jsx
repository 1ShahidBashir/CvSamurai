...
import { ArrowRight, LampDesk, Languages, LayoutTemplate , Zap, Download} from 'lucide-react';
              ...
              <div className={landingPageStyles.ctaCardContent}>
                ...
                <button className={landingPageStyles.ctaButton}
                  onClick={handleCTA}>
                    ...
                    <div className={landingPageStyles.ctaButtonText}>Start Building</div>
                  </button>
              </div>
            </div>
          </div>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            ...
            <a href="https://google.com" target='_blank' className={landingPageStyles.footerLink}>Sam</a>
          </p>
        </div>
      </footer>
