    ...
    const ref= useCallback((node)=>{
        if(node){
            const resizeObserver= new ResizeObserver((entrie)=>{
                const {width, height}= entrie[0].contentRect;
  ...
  const [resumeData, setResumeData] = useState({
    ...
    return (
        <DashboardLayout>
                    ...
                    <div className={containerStyles.formContainer}>
                        ...
                        <div className='p-4 sm:p-6'>
                            ...
                            <div className='flex flex-wrap items-center justify-end gap-3'>
                                ...
                                <button className={buttonStyles.next} onClick={validateAndNext}
                                    disabled={isLoading}>
                            ...
                            <div className='preview-container relative' ref={previewContainerRef}>
                                <div className={containerStyles.previewInner}>
                                    <RenderResume key={`preview-${resumeData?.template?.theme}`}
                                        templateId={resumeData?.template?.theme || ""} resumeData={resumeData}
            ...
            <Model isOpen={openPreviewModal} onClose={()=>setOpenPreviewModal(false)}
